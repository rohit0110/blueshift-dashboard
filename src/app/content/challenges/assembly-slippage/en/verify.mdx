...
Now that you should starting to be comfortable writing Assembly, instead of using just a normal account, your slippage check should work for both SPL-Token and Token2022 Accounts.
